...
JasonGenerator['property_affordance'] = function(block){
  ...
  if(resultBlock.type == "variable"){
    ...
    extractCode = indent+generationUtils.getObjectExtractCode(generationUtils.getRootStatement(resultBlock), indent, resultVar)
  }
...
JasonGenerator['action_affordance'] = function(block){
  ...
  if(outputBlock){
    if(outputBlock.type == "variable"){
      ...
      extractCode = indent+generationUtils.getObjectExtractCode(generationUtils.getRootStatement(outputBlock), indent, resultVar)
    }
  }
